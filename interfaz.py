...
class Ui_vtnPrincipal(object):
    def setupUi(self, vtnPrincipal):
        ...
        self.btnAccion = QPushButton(self.centralwidget)
        self.btnAccion.setObjectName(u"btnAccion")
        self.btnAccion.setGeometry(QRect(270, 190, 75, 23))
        palette1 = QPalette()
        ...
        self.btnAccion.setPalette(palette1)
